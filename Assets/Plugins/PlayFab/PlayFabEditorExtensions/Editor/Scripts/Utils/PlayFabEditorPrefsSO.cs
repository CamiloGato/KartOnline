    ...
    public class PlayFabEditorPrefsSO : ScriptableObject
    {
        ...
        public static PlayFabEditorPrefsSO Instance
        {
            get
            {
                ...
                if (!Directory.Exists(Path.Combine(Application.dataPath, "Plugins/PlayFab/PlayFab/EditorExtensions/Editor/Resources")))
                    Directory.CreateDirectory(Path.Combine(Application.dataPath, "Plugins/PlayFab/PlayFabEditorExtensions/Editor/Resources"));
                ...
                AssetDatabase.CreateAsset(_instance, "Assets/Plugins/PlayFab/PlayFabEditorExtensions/Editor/Resources/PlayFabEditorPrefsSO.asset");
