...
namespace PlayFab.PfEditor
{
    ...
    public class PlayFabEditorSettings : UnityEditor.Editor
    {
        ...
        private static void DrawApiSubPanel()
        {
            ...
            {
                BuildTargetGroup nameBuildTargetGroup = EditorUserBuildSettings.selectedBuildTargetGroup;
                NamedBuildTarget nameBuildTarget = NamedBuildTarget.FromBuildTargetGroup(nameBuildTargetGroup);
                var curDefines = PlayerSettings.GetScriptingDefineSymbols(nameBuildTarget);
                ...
                if (changedFlags)
                {
                    PlayerSettings.SetScriptingDefineSymbols(nameBuildTarget, curDefines);
